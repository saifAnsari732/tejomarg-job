...
import { Phone, ArrowRight, Loader2, Building, CheckCircle2 } from "lucide-react";
      ...
      <div className="hidden lg:flex w-1/2 relative bg-slate-900 overflow-hidden items-center justify-center shadow-2xl z-10">
        ...
        <div className="relative z-20 text-center px-12 max-w-xl mx-auto flex flex-col items-center">
          ...
          <p className="text-lg text-slate-200 leading-relaxed font-medium drop-shadow-md">
            Connect with top talent and manage your hiring pipeline efficiently.
          </p>
        </div>
      </div>
              ...
              >
                ...
                <form onSubmit={handleSendOtp} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center py-3.5 px-4 rounded-xl text-white bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 focus:ring-4 focus:ring-emerald-500/20 font-bold transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed shadow-lg shadow-emerald-500/25 group"
                  >
                    {loading ? (
                ...
                <div className="mt-8">
                  ...
                  <button
                    type="button"
                    onClick={() => signIn("google", { callbackUrl: "/employer/post-job" })}
