...
// GSAP-powered components (client-side)
const AnimatedHeroTextGSAP = dynamic(() => import("./AnimatedHeroTextGSAP"), { ssr: false });
const HeroGSAPClient = dynamic(() => import("./HeroGSAPClient"), { ssr: false });
const GSAPReveal = dynamic(() => import("./GSAPReveal"), { ssr: false });
  ...
  return (
    <section className="relative w-full pt-12 md:pt-24 pb-20 md:pb-32 overflow-hidden bg-gradient-to-b from-blue-50 via-white to-slate-50 min-h-[90vh] flex flex-col justify-center">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-30 flex flex-col items-center text-center w-full">
        ...
        {/* Top Label - fast entrance */}
        <GSAPReveal delay={0} from="bottom" className="mb-8">
        ...
        <GSAPReveal delay={0.1} from="bottom" className="w-full">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-slate-900 leading-tight mb-6 tracking-tight w-full flex flex-col items-center">
        ...
        {/* Subtitle */}
        <GSAPReveal delay={0.2} from="bottom" className="w-full">
          <p className="text-slate-600 text-sm sm:text-lg max-w-2xl mb-8 leading-relaxed font-medium px-2 w-full mx-auto">
        ...
        {/* Feature Highlights */}
        <GSAPReveal delay={0.3} from="bottom" className="w-full">
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-8 mb-12 text-sm sm:text-base text-slate-600 font-semibold">
        ...
        {/* Search Bar */}
        <GSAPReveal delay={0.4} from="bottom" className="w-full max-w-4xl relative z-40">
          <HeroSearchClient />
        </GSAPReveal>

        {/* Popular Tags */}
        <GSAPReveal delay={0.5} from="bottom" className="w-full mt-8">
        ...
        {/* Trusted By Marquee - scroll triggered */}
        <div className="w-full mt-28 pt-10 border-t border-slate-200 relative z-20">
          <GSAPReveal scrollTrigger delay={0} from="fade" className="">
