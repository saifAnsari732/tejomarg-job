    ...
    <div className="w-full">
      ...
      {jobs.length > 0 && (
        <div className="space-y-4">
          {jobs.map((job: any) => (
            <div key={job.id}
              className="group bg-white rounded-xl border border-slate-200 hover:border-blue-400 hover:shadow-md transition-all duration-200 p-5">
              
              <div className="flex items-start justify-between gap-4">
                <div className="flex gap-4 min-w-0">
                  {/* Logo */}
                  <a href={job.applyUrl} target="_blank" rel="noopener noreferrer" className="shrink-0">
                    <div className="w-12 h-12 rounded-lg border border-slate-100 p-1 flex items-center justify-center bg-white shadow-sm overflow-hidden">
                      {job.companyLogo ? (
                ...
                <div className="hidden sm:block shrink-0">
                  <a href={job.applyUrl} target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white font-semibold transition-colors text-sm border border-blue-100 hover:border-blue-600">
              ...
              <div className="flex flex-wrap items-center gap-2 mt-4">
                ...
                {job.isRemote && (
                  <span className="px-2.5 py-1 rounded bg-emerald-50 text-emerald-700 text-xs font-semibold border border-emerald-100 flex items-center">
              ...
              <div className="flex items-center justify-between mt-4 pt-4 border-t border-slate-100">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Link href={`/jobs/live/${job.id}`}
                    className="text-sm font-bold text-slate-600 hover:text-blue-600 flex items-center transition-colors">
